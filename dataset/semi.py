from dataset.transform import crop, hflip, normalize, resize, blur,cutout,Cutmix,Cutout1,RandomGaussianBlur
...
class SemiDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        #################################################
        # cutmix = Cutmix(prop_range=0.5)
        # img, label, mask = cutmix(img, mask)
        img, mask = normalize(img, mask)
        cutout1 = Cutout1()
        img, mask = cutout1(img, mask)
        #################################################
